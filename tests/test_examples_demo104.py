...
TEST_PARAMETERS = [
    ...
    (["command1", "Alice"], 
     "Run Command 1: Hello Alice", 
     0),
    
    # Test command1 with force flag
    (["command1", "--force", "Bob"], 
     "Run Command 1: Hello Bob", 
     0),
    ...
    (["--debug", "command1", "Charlie"], 
     "Run Command 1: Hello Charlie", 
     0),
    
    # Test sub2b command (should raise NotImplementedError)
    (["command1", "sub2", "sub2", "sub2b"], 
     "No 'cli_run' method found", 
     31),
]

@pytest.mark.tags("examples", "examples-unit")
@pytest.mark.parametrize("cli_args, expected_output, expected_exit", TEST_PARAMETERS)
def test_demo104_nested_cli(demo104_app, capsys, cli_args, expected_output, expected_exit):
...
@pytest.mark.parametrize("cli_args, expected_output, expected_exit", TEST_PARAMETERS)
def test_demo104_nested_cli_regression(demo104_app, capsys, data_regression, cli_args, expected_output, expected_exit):
