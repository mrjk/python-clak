...
TEST_PARAMETERS = [
    ...
    (["command1", "--source", "Lake"], 
     "Source: Lake", 
     0),
    
    # Test command1 with force flag
    (["command1", "--force", "--source", "River"], 
     "Source: River", 
     0),
    ...
    (["invalid-command"], 
     "Could not parse command line: __cli_cmd__1", 
     2),
...
def test_demo106_inherit_mixed_cli(demo106_app, capsys, cli_args, expected_output, expected_exit):
...
@pytest.mark.parametrize("cli_args, expected_output, expected_exit", TEST_PARAMETERS)
def test_demo106_inherit_mixed_cli_regression(demo106_app, capsys, data_regression, cli_args, expected_output, expected_exit):
