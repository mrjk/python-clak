...
TEST_PARAMETERS = [
    ...
    (["command1", "--help"], 
     "Another epilog for this child command", 
     0),
    
    # Test help on command2 to verify custom usage
    (["command2", "--help"], 
     "command usage for command2 can be overriden", 
     0),
...
def test_demo107_docstring_cli(demo107_app, capsys, cli_args, expected_output, expected_exit):
...
@pytest.mark.parametrize("cli_args, expected_output, expected_exit", TEST_PARAMETERS)
def test_demo107_docstring_cli_regression(demo107_app, capsys, data_regression, cli_args, expected_output, expected_exit):
