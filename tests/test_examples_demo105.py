...
import pytest
from examples.demo105_inherit import AppMain
...
def demo105_app():
    ...
    return AppMain(proc_name="demo105-test")
...
def test_demo105_inherit_cli(demo105_app, capsys, cli_args, expected_output, expected_exit):
...
@pytest.mark.parametrize("cli_args, expected_output, expected_exit", TEST_PARAMETERS)
def test_demo105_inherit_cli_regression(demo105_app, capsys, data_regression, cli_args, expected_output, expected_exit):
